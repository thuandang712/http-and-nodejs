...
// var server = http.createServer(function(req, res) { // create instance of a server 
//   var guests = ['Mary', 'Don'];
//   var guestsJSON = JSON.stringify(guests); // turns array into a string to send via http
